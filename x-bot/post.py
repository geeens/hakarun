...
TOOLS = [
    ...
    {'name': '社会保険料シミュレーション', 'url': 'https://hakarun.net/money/shakaihoken.html', 'cat': 'お金', 'hint': '社会保険料は給与の約14〜15%。会社も同額を負担している'},
    {'name': '退職金手取り計算', 'url': 'https://hakarun.net/money/taisyokukin.html', 'cat': 'お金', 'hint': '勤続20年超えると退職金の税控除が大きくなる'},
    {'name': '消費税計算', 'url': 'https://hakarun.net/money/shohizei.html', 'cat': 'お金', 'hint': '税込価格から税抜きを出すには÷1.1'},
    {'name': '割り勘計算', 'url': 'https://hakarun.net/money/warikan.html', 'cat': 'お金', 'hint': '人数と合計金額を入れるだけで一人分をすぐ計算'},
    {'name': '住民税計算', 'url': 'https://hakarun.net/money/juuminzei.html', 'cat': 'お金', 'hint': '住民税は前年の所得に対してかかる。退職後に一括請求されることも'},
    {'name': '手取りから額面逆算', 'url': 'https://hakarun.net/money/gyaku.html', 'cat': 'お金', 'hint': '手取り30万円が欲しいなら額面は約39万円必要'},
    {'name': '副業収入の税金計算', 'url': 'https://hakarun.net/money/fukugyo.html', 'cat': 'お金', 'hint': '副業収入が年20万円を超えると確定申告が必要'},
    {'name': '育児休業給付金計算', 'url': 'https://hakarun.net/money/ikukyu.html', 'cat': 'お金', 'hint': '育休中は最初の180日間は給与の67%が支給される'},
    {'name': '傷病手当金計算', 'url': 'https://hakarun.net/money/shobyo.html', 'cat': 'お金', 'hint': '病気で休んでも給与の約2/3が最大1年半もらえる'},
    {'name': '雇用保険・失業給付計算', 'url': 'https://hakarun.net/money/koyo.html', 'cat': 'お金', 'hint': '失業手当は離職前6ヶ月の平均給与の50〜80%'},
    {'name': '年金受給額シミュレーション', 'url': 'https://hakarun.net/money/nenkin.html', 'cat': 'お金', 'hint': '平均年収400万円で40年加入すると老齢厚生年金は月約10万円'},
    # 健康・医療
    {'name': 'BMI計算', 'url': 'https://hakarun.net/health/bmi.html', 'cat': '健康', 'hint': 'BMI22が最も病気になりにくい標準体重。25以上が肥満の目安'},
    {'name': '基礎代謝計算', 'url': 'https://hakarun.net/health/metabolism.html', 'cat': '健康', 'hint': '基礎代謝は30代から年1%ずつ低下する'},
    {'name': '消費カロリー計算', 'url': 'https://hakarun.net/health/calorie.html', 'cat': '健康', 'hint': '1kgの脂肪を落とすには約7,200kcalの消費が必要'},
    {'name': '体脂肪率計算', 'url': 'https://hakarun.net/health/taishibo.html', 'cat': '健康', 'hint': '男性の標準体脂肪率は10〜20%、女性は20〜30%'},
    {'name': '睡眠時間計算', 'url': 'https://hakarun.net/health/suimin.html', 'cat': '健康', 'hint': '睡眠は90分サイクル。6時間・7.5時間で起きると目覚めやすい'},
    {'name': '水分補給量計算', 'url': 'https://hakarun.net/health/suibun.html', 'cat': '健康', 'hint': '1日に必要な水分量は体重×35ml。体重60kgなら約2.1リットル'},
    {'name': 'アルコール分解時間計算', 'url': 'https://hakarun.net/health/alctime.html', 'cat': '健康', 'hint': 'ビール500mlが抜けるのに約3〜4時間かかる'},
    {'name': 'ストレス度チェック', 'url': 'https://hakarun.net/health/stress.html', 'cat': '健康', 'hint': 'ストレスは数値化できる。ライフイベントの積み重ねで健康リスクがわかる'},
    # 暮らし・節約
    {'name': 'ローン返済シミュレーション', 'url': 'https://hakarun.net/life/loan.html', 'cat': '暮らし', 'hint': '3000万を35年・金利1%で借りると総返済額は約3550万円'},
    {'name': '電気代計算', 'url': 'https://hakarun.net/life/denki.html', 'cat': '暮らし', 'hint': 'エアコン1台を1日8時間使うと月約6,500円かかる'},
    {'name': 'ガソリン代計算', 'url': 'https://hakarun.net/life/gasoline.html', 'cat': '暮らし', 'hint': '燃費10km/Lの車で月1,000km走るとガソリン代は約17,000円'},
    {'name': '積立貯金シミュレーション', 'url': 'https://hakarun.net/life/chochiku.html', 'cat': '暮らし', 'hint': '毎月3万円を20年積み立てると元本720万円になる'},
    {'name': 'スマホ代節約計算', 'url': 'https://hakarun.net/life/sumaho.html', 'cat': '暮らし', 'hint': '大手から格安SIMに変えると年間6〜12万円節約できることも'},
    {'name': '車の維持費計算', 'url': 'https://hakarun.net/life/kuruma.html', 'cat': '暮らし', 'hint': '普通車の年間維持費は平均約40〜50万円。月3〜4万円かかる'},
    {'name': '旅行費用計算', 'url': 'https://hakarun.net/life/travel.html', 'cat': '暮らし', 'hint': '人数・泊数・交通費を入れると旅行の合計費用がすぐわかる'},
    ...
    {'name': '住宅ローン控除・還付金計算', 'url': 'https://hakarun.net/tax/jutaku.html', 'cat': '節税', 'hint': 'ローン残高の0.7%が毎年所得税から控除される。最大13年間'},
    {'name': 'iDeCo節税計算', 'url': 'https://hakarun.net/tax/ideco.html', 'cat': '節税', 'hint': 'iDeCoで月2万円積み立てると年間約4.8万円節税できる（年収500万の場合）'},
    {'name': '贈与税計算', 'url': 'https://hakarun.net/tax/gift.html', 'cat': '節税', 'hint': '年間110万円以内の贈与なら贈与税がかからない'},
    # 計算・変換
    {'name': 'パーセント計算', 'url': 'https://hakarun.net/calc/percent.html', 'cat': '計算', 'hint': '30%オフの金額や消費税込みの計算をかんたんに'},
    {'name': '外貨換算', 'url': 'https://hakarun.net/calc/gaika.html', 'cat': '計算', 'hint': '海外旅行前に円→ドル・ユーロをかんたん計算'},
    {'name': '偏差値計算', 'url': 'https://hakarun.net/calc/hensachi.html', 'cat': '計算', 'hint': '点数・平均点・標準偏差を入れると偏差値がすぐわかる'},
    ...
    {'name': '生命保険必要額計算', 'url': 'https://hakarun.net/invest/seimei.html', 'cat': '投資', 'hint': '必要な保険金額は家族構成・年収・ローン残高によって大きく変わる'},
]
